...
# Node
# Increases the default memory limit for Node, so larger projects can be built
export NODE_OPTIONS=--max_old_space_size=8192
...
printHeading "Installing Applications"
    ...
    printStep "Laravel Herd"                "brew install --cask herd"
    printStep "Macs Fan Control"            "brew install --cask macs-fan-control"
    printStep "Medis"                       "brew install --cask medis"
    printStep "Microsoft Edge"              "brew install --cask microsoft-edge"
    printStep "Microsoft Excel"             "brew install --cask microsoft-excel"
    printStep "Microsoft Outlook"           "brew install --cask microsoft-outlook"
    printStep "Microsoft PowerPoint"        "brew install --cask microsoft-powerpoint"
    printStep "Microsoft Word"              "brew install --cask microsoft-word"
    printStep "OpenSubtitles FlixTools"     "brew install --cask flixtools"
    printStep "Plex"                        "brew install --cask plex"
    printStep "Postman"                     "brew install --cask postman"
    printStep "Prism Launcher"              "brew install --cask prismlauncher"
    ...
    printStep "Steam"                       "brew install --cask steam"
    printStep "Sublime Merge"               "brew install --cask sublime-merge"
    printStep "TablePlus"                   "brew install --cask tableplus"
    printStep "Telegram"                    "brew install --cask telegram"
    printStep "Temurin"                     "brew install --cask temurin"
    printStep "The Unarchiver"              "brew install --cask the-unarchiver"
    ...
    printStep "Visual Studio Code Insiders" "brew install --cask visual-studio-code-insiders"
